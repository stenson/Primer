...
- (void)insertNewObject:(id)sender
{
    ...
    Memory *newMemory = [[Memory alloc] initWithEntity:entity insertIntoManagedObjectContext:context];
//    NSManagedObject *newManagedObject = [NSEntityDescription insertNewObjectForEntityForName:[entity name] inManagedObjectContext:context];
    
    // If appropriate, configure the new managed object.
    // Normally you should use accessor methods, but using KVC here avoids the need to add a custom class to the template.
    newMemory.created = [NSDate date];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([[UIDevice currentDevice] userInterfaceIdiom] == UIUserInterfaceIdiomPhone) {
	    if (!self.detailViewController) {
	        self.detailViewController = [[ADKDetailViewController alloc] initWithNibName:@"ADKDetailViewController_iPhone" bundle:nil];
	    }
